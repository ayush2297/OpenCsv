...
public class WriteToCsv {
    ...
    public static void main(String[] args) throws IOException,
        ...
        try (
            ...
            myUsers.add(new CsvUser("Sundar Pichai ♥", "sundar.pichai@gmail.com", "+1-1111111111", "India"));
            myUsers.add(new CsvUser("Satya Nadella", "satya.nadella@outlook.com", "+1-1111111112", "India"));
